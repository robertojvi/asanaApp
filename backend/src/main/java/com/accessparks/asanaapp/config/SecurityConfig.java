package com.accessparks.asanaapp.config;

import com.accessparks.asanaapp.security.JwtAuthFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/projects/**", "/api/reports/**", "/api/tasks/**").authenticated()
                ...
                .requestMatchers("/api/projects/**", "/api/sync/**", "/api/tasks/**").hasAnyRole("SUPER_USER", "ADMIN")
